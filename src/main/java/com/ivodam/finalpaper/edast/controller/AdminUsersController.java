...
public class AdminUsersController {
  ...
  public String getAll(@RequestParam(defaultValue = "") String search,
    ...
    case "Admin" ->
      model.addAttribute(
          "users", userService.findAllByRole(Enums.Roles.ROLE_ADMIN, pageable));
    case "User" ->
      model.addAttribute(
          "users", userService.findAllByRole(Enums.Roles.ROLE_USER, pageable));
    case "Employee" ->
      model.addAttribute("users", userService.findAllByRole(
                                      Enums.Roles.ROLE_EMPLOYEE, pageable));
    case "All" ->
      model.addAttribute(
          "users",
          userService.findAllByEmailOrNameOrJobTitleContainingIgnoreCase(
              search, pageable));
    }
  ...
  public String getUserById(Model model, @PathVariable UUID id)
      throws AppException {
  ...
  public String editUserById(Model model, @PathVariable UUID id)
      throws AppException {
  ...
  public String editUserById(@PathVariable UUID id,
    ...
    userService.updateUserAccount(id, user);
